...
public class Transportadora implements ImportacaoArquivos{
    ...
    public Transportadora(){
        this.vetEncNormal = new EncomendaNormal[tamVet];
        this.vetEncExpressa = new EncomendaExpressa[tamVet];
        this.qtdEncNormal = 0;
    ...
    public void importarDados(String arqDadosEntrada){
        try{ //tentando ler o arquivo
            ...
            while((linha = arquivo.readLine()) != null){
                ...
                if((sigla.equals("EN")) && (getQtdEncNormal() < tamVet)){ //se for encomenda "EN", salva no vetor de encomendas normais
                ...
                }else if((sigla.equals("EE")) && (getQtdEncExpressa() < tamVet)){
