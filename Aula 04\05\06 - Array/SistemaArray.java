...
public class SistemaArray {
    ...
    public static void main(String[] args) throws Exception {
        SistemaArray se = new SistemaArray();
        se.e1 = new Escola();
    ...
    private void menu() throws Exception{
        ...
        while(!opcao.equals("4")){ 
            ...
            switch(opcao) {
                case "1" -> // Chamando o metodo de cadastro da turma
                    CadastrarTurma();

                case "2" -> // Chamando o metodo que lista as turmas
                    listarTurmas();

                case "3" -> // Chamando o metodo que consulta uma turma
                    consultarTurma();
